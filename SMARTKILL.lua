local success, VALID_KEY = pcall(function()
    local key = game:HttpGet("https://raw.githubusercontent.com/rizkyyrz/Project-/refs/heads/main/key.txt")
    return key:gsub("%s+", "")
end)
...
login.MouseButton1Click:Connect(function()
    ...
    local function MakeStat(name,arg)
        ...
        StatsSec:NewToggle("Auto "..name, "", function(v)
    ...
    MiscSec:NewToggle("Auto AFK Lock", "", function(state)
